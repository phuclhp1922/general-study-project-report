...
\usepackage{booktabs}
\usepackage{multirow}
\usepackage{rotating}   % for sideways header if you want
\usepackage{iftex}
...
\title{MORAv2 - A Mixed-Integer Linear Programming Framework for Real-Time Resource Allocation in Building Fire Emergencies}

\author{\IEEEauthorblockN{Khoa Nguyen Hoang Anh\IEEEauthorrefmark{1}, Phuc Nguyen Song Thien\IEEEauthorrefmark{1}, and Do Cao Kim\IEEEauthorrefmark{1}}

\IEEEauthorblockA{\IEEEauthorrefmark{1}Vietnamese-German University,

Ho Chi Minh City, Vietnam\\

\texttt{\{10422037, 10422067, 10422018\}@student.vgu.edu.vn}}}
...
Operating through a lexicographic optimization strategy, the algorithm sequentially calculates optimal deployment to strictly minimize the total population at risk, property loss, and operational transit times. 
The results demonstrate the solver’s computational viability, bridging the gap between passive smart-building technologies and active mathematical optimization for real-time indoor emergency response.
\end{abstract}

\begin{IEEEkeywords}
Optimization, Resource Allocation, Mixed-Integer Linear Programming, Decision Support Systems, Building Fire Emergencies
...
We would like to express their sincere thanks and deepest gratitude to Dr. Dinh Hai Dung for his invaluable guidance, insightful feedback, and continuous support throughout the development of this research. His expertise and encouragement greatly contributed to shaping the ideas and improving the quality of this work.

We also appreciate the academic environment and resources provided by the faculty and staff, which made it possible to conduct this research effectively. Their support and dedication to fostering learning and innovation are sincerely acknowledged.

Finally, we would like to thank all colleagues and peers who offered constructive discussions and encouragement during the course of this study.
...
%
\noindent
All links were last followed on March 12th, 2026.
